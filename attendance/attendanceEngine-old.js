...
.attendance-input-panel {
    ...
    overflow-y: auto; /* Allowed vertical scroll */
    overflow-x: auto;
}
...
.attendance-table input.reason-schoolwork {
    min-width: 150px;
}
...
<div class="attendance-container">
    ...
    <div class="attendance-input-panel" id="inputPanel">
        <div class="attendanceInputHeader-conductGradeHeader-panel">
            ...
            <div class="attendance-control-panel">
                ...
                <div class="space-y-2">
                    <div>
                        <label class="font-bold text-sm block">Section:</label>
                        <select id="SectionSelect" class="w-full p-1 border rounded">
                            <option value="">-- Select Section --</option>
                        </select>
                    </div>
                    <div>
                        <label class="font-bold text-sm block">Date:</label>
                        <input type="date" id="attendanceDate" class="w-full p-1 border rounded" />
                    </div>
                    <div>
                        <label class="font-bold text-sm block">Day Type:</label>
                        <select id="dayType" class="w-full p-1 border rounded">
                    ...
                    <button id="saveAttendanceBtn" class="w-full bg-blue-600 text-white font-bold py-2 rounded hover:bg-blue-700 mt-2">
                        Save Attendance
                    </button>
                </div>
            </div>
            ...
            <div class="conductGradeHeader-pane" id="conductDescPanel">
                <h3 class="font-bold">Conduct Description</h3>
                <ul class="text-xs list-disc pl-4 space-y-1">
                    <li><strong>Prayer Life</strong>: Respectful disposition during prayer.</li>
                    <li><strong>Relationship to oneself/others</strong>: Self-discipline and respect.</li>
                    <li><strong>Attitude toward schoolwork</strong>: Responsibility, punctuality, industry, honesty.</li>
                </ul>
                <h3 class="font-bold mt-2">Grades</h3>
                <ul class="text-xs list-disc pl-4 grid grid-cols-2 gap-x-4">
                    <li><strong>A</strong>: Exceptional</li>
                    <li><strong>B+</strong>: Generally good</li>
                    <li><strong>B</strong>: Satisfactory</li>
                    <li><strong>C+</strong>: Some extent</li>
                    <li><strong>C</strong>: Needs reminders</li>
                    <li><strong>D</strong>: Frequent offenses</li>
                </ul>
            </div>
        </div>
    ...
    <div class="attendance-record-panel" id="recordPanel">
        <div class="p-2">
            <button id="toggleAttendanceInputPanelBtn" class="toggle-btn mb-2" title="Show/Hide Records"><< Records</button>
